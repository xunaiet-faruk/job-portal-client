...
const Addjobs = () => {
    const handleSubmit =e=>{
        ...
        console.log(email,title,date,description,categor,mini,max);
    }
    return (
        <div>
                    ...
                    <form onSubmit={handleSubmit} className="space-y-6">
                        ...
                        <div>
                            ...
                            <input
                                type="email"
                               name='email'
                                className="w-full px-4 py-3 rounded-xl bg-gray-100 border border-gray-300 cursor-not-allowed focus:outline-none"
                            />
                        </div>
                        ...
                        <button
                            type="submit"
                            className="w-full py-3 rounded-xl font-bold text-white bg-gradient-to-r from-purple-600 to-pink-500 hover:scale-105 transform transition duration-300 shadow-lg"
                        >
                            🚀 Add Job
                        </button>
